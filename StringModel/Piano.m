% Piano model originally written by Teng Wei Jian
% Orignal source:
% http://www.acoustics.ed.ac.uk/wp-content/uploads/AMT_MSc_FinalProjects/
% 2012__Teng__AMT_MSc_FinalProject_PianoSynthesis.pdf
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Define coefficients of wave equation%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
D=1+b1/Fs+2*b3*Fs;
r=c*N/(Fs*L);
...
%               the actual length being implemented
...
% Hl    The Loss Filter
% Hd
% Hfd   One of the the allpass filters that make up the Dipersion Filter 
%       Hfd1, Hfd2 and Hfd2 are the Tuning Filters used to tune the 
...
%       the Dispersion Filter and the Tuning Filter.
%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
z=tf('z',1/Fs);
DL1=(z)^-(M-i0);
...
if C*(1+offtune)>=1                 % Makes sure the coefficient of the
    Hfd2=(1+z^-1)/(1+1*z^-1);       % Tuning filter does not exceed 1.
end
