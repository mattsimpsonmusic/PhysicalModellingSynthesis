...
for n = 1:N_IR
    ...
    % Parallel FBCFs
    [comb1,buffer1,fbLPF1] = FeedbackComb(IR_test(n,1),buffer1,n,d1,g1,fbLPF1,true);
    [comb2,buffer2,fbLPF2] = FeedbackComb(IR_test(n,1),buffer2,n,d2,g2,fbLPF2,true);
    [comb3,buffer3,fbLPF3] = FeedbackComb(IR_test(n,1),buffer3,n,d3,g3,fbLPF3,true);
    [comb4,buffer4,fbLPF4] = FeedbackComb(IR_test(n,1),buffer4,n,d4,g4,fbLPF4,true);
...
for n = 1:N_out
    ...
    % Four Parallel FBCFs
    [comb1_out,buffer1,fbLPF1] = FeedbackComb(in(n,1),buffer1,n,d1,g1,fbLPF1,true);
    [comb2_out,buffer2,fbLPF2] = FeedbackComb(in(n,1),buffer2,n,d2,g2,fbLPF2,true);
    [comb3_out,buffer3,fbLPF3] = FeedbackComb(in(n,1),buffer3,n,d3,g3,fbLPF3,true);
    [comb4_out,buffer4,fbLPF4] = FeedbackComb(in(n,1),buffer4,n,d4,g4,fbLPF4,true);
...
audiowrite('drums_7d.wav', out, Fs);
sound(out,Fs);
